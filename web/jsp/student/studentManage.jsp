...
<html>
	...
	<script type="text/javascript">
		...
		function  add(){
     		 var url='<%=request.getContextPath()%>/jsp/student/addStudent.jsp';
			 commonUtil.showModal(url,{width:"450",height:"300px",title:'新增学生信息',confimCall:'ev_confirm',confimCallback:function(){
			 	query();
			 }});
		}
		var modId='';
		...
		function mod(){
			 ...
			 modId=id;
     		 var url='<%=request.getContextPath()%>/jsp/student/addStudent.jsp?id='+id;
			 commonUtil.showModal(url,{width:"450",height:"300px",title:'修改学生信息',confimCall:'ev_confirm',confimCallback:function(){
			 	query();
			 }});
		}
		...
		function del(){
     		...
     		var url = "<%=request.getContextPath() %>/entry.do?action=student&method=delByAjax";
		...
		function queryData(page){
			var html="";
			var url = "<%=request.getContextPath() %>/entry.do?action=student&method=queryByPageAjax";
			var name=document.getElementById("name").value;
			var phone=document.getElementById("phone").value;
			var sex=document.getElementById("sex").value;
			var build=document.getElementById("buildDiv").value;
			var dorm=document.getElementById("dormDiv").value;
			$.post(url,{r:Math.random(),name:encodeURIComponent(name),phone:phone,sex:sex,build_id:build,dorm:dorm,
